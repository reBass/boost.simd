...
STF_CASE_TPL (" log10", STF_IEEE_TYPES)
{
  ...
  using r_t = decltype(bs::musl_(log10)(T()));

  // return type conformity test
  STF_TYPE_IS(r_t, T);
  // specific values tests
#ifndef BOOST_SIMD_NO_INVALIDS
  STF_ULP_EQUAL(bs::musl_(log10)(bs::Inf<T>()), bs::Inf<r_t>(), 0);
  STF_ULP_EQUAL(bs::musl_(log10)(bs::Minf<T>()), bs::Nan<r_t>(), 0);
  ...
  STF_ULP_EQUAL(bs::musl_(log10)(bs::Three<T>()),T(0.477121254719662437295027903255), 0.5);
}
